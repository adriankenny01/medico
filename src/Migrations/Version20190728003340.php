 ...
 */
final class Version20190728003340 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state INT DEFAULT NULL, CHANGE image image VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE date_start date_start DATE DEFAULT \'NULL\', CHANGE date_end date_end VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
