 ...
 */
final class Version20190316172506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic DROP days_of_consulting, CHANGE state state INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic ADD days_of_consulting INT NOT NULL, CHANGE state state SMALLINT DEFAULT NULL');
