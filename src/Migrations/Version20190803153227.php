 ...
 */
final class Version20190803153227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        // $this->addSql('ALTER TABLE medic CHANGE state state INT NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE date_start date_start DATE NOT NULL, CHANGE date_end date_end VARCHAR(20) NOT NULL');
        ...
        // $this->addSql('ALTER TABLE patient CHANGE photo photo VARCHAR(255) NOT NULL, CHANGE username username VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD photo VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL');
        // $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649F85E0677 ON user (username)');
        // $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        // $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D6498CDE5729 ON user (type)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state INT DEFAULT NULL, CHANGE image image LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE date_start date_start DATE DEFAULT \'NULL\', CHANGE date_end date_end VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE patient CHANGE photo photo LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE username username VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE password password VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE schedule CHANGE state state SMALLINT DEFAULT NULL');
        $this->addSql('DROP INDEX UNIQ_8D93D649F85E0677 ON user');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74 ON user');
        $this->addSql('DROP INDEX UNIQ_8D93D6498CDE5729 ON user');
        $this->addSql('ALTER TABLE user DROP photo, CHANGE name name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
