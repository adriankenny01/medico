 ...
 */
final class Version20190316165452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic_group CHANGE name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic_group CHANGE name name LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
