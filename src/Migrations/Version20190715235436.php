 ...
 */
final class Version20190715235436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E3DADF758C03F15C ON vacation');
        // $this->addSql('ALTER TABLE vacation CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE medic_id medic_id INT DEFAULT NULL, CHANGE days_taken days_taken INT DEFAULT NULL, CHANGE observations observations VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vacation ADD CONSTRAINT FK_E3DADF758C03F15C FOREIGN KEY (employee_id) REFERENCES employee (id)');
        $this->addSql('CREATE INDEX IDX_E3DADF75409615FE ON vacation (medic_id)');
        $this->addSql('CREATE INDEX IDX_E3DADF758C03F15C ON vacation (employee_id)');
    }
}
