 ...
 */
final class Version20190321043446 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE phone phone INT NOT NULL');
        // $this->addSql('ALTER TABLE appoinment CHANGE state state INT NOT NULL, CHANGE url url TINYTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appoinment CHANGE url url VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE state state INT DEFAULT NULL');
        $this->addSql('ALTER TABLE category CHANGE state state SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE employee CHANGE state state INT DEFAULT NULL');
        $this->addSql('ALTER TABLE medic CHANGE phone phone INT DEFAULT NULL, CHANGE state state SMALLINT DEFAULT NULL, CHANGE image image BLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE medic_group CHANGE state state SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE patient CHANGE state state INT DEFAULT NULL');
