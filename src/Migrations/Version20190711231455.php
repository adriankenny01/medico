 ...
 */
final class Version20190711231455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state INT NOT NULL, CHANGE date_end date_end VARCHAR(20) NOT NULL');
        ...
        $this->addSql('ALTER TABLE vacation CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE days_taken days_taken INT DEFAULT NULL, CHANGE observations observations VARCHAR(255) DEFAULT NULL, CHANGE date_init date_init VARCHAR(255) DEFAULT NULL, CHANGE medic_id medic_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vacation CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE medic_id medic_id INT DEFAULT NULL, CHANGE days_taken days_taken INT DEFAULT NULL, CHANGE observations observations VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE date_init date_init VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
