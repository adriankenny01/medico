 ...
 */
final class Version20190711213226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE image image VARCHAR(100) NOT NULL, CHANGE card_id card_id LONGTEXT NOT NULL');
