 ...
 */
final class Version20190708025033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD icon VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category DROP icon, CHANGE state state SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE employee CHANGE state state INT DEFAULT NULL');
