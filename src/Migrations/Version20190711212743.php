 ...
 */
final class Version20190711212743 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic ADD card_id varchar(100) NOT NULL, DROP zip_code, DROP nif, DROP days_of_consulting, CHANGE date_start date_start VARCHAR(20) NOT NULL, CHANGE date_end date_end VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic ADD zip_code INT NOT NULL, ADD nif INT NOT NULL, ADD days_of_consulting INT NOT NULL, DROP card_id, CHANGE date_start date_start DATE NOT NULL, CHANGE date_end date_end DATE NOT NULL');
