 ...
 */
final class Version20190711024140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD photo varchar(100) NOT NULL, DROP zip_code, DROP nif');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD zip_code INT NOT NULL, ADD nif INT NOT NULL, DROP photo, CHANGE state state SMALLINT DEFAULT NULL');
