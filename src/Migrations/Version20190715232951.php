 ...
 */
final class Version20190715232951 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE date_start date_start DATE NULL');
        ...
        // $this->addSql('ALTER TABLE vacation CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE days_taken days_taken INT DEFAULT NULL, CHANGE observations observations VARCHAR(255) DEFAULT NULL, CHANGE medic_id medic_id INT DEFAULT NULL');
        // $this->addSql('ALTER TABLE vacation ADD CONSTRAINT FK_E3DADF75409615FE FOREIGN KEY (medic_id) REFERENCES medic (id)');
        // $this->addSql('CREATE INDEX IDX_E3DADF75409615FE ON vacation (medic_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state INT DEFAULT NULL, CHANGE date_start date_start VARCHAR(20) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE date_end date_end VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE vacation DROP FOREIGN KEY FK_E3DADF75409615FE');
        $this->addSql('DROP INDEX IDX_E3DADF75409615FE ON vacation');
        $this->addSql('ALTER TABLE vacation CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE medic_id medic_id INT DEFAULT NULL, CHANGE days_taken days_taken INT DEFAULT NULL, CHANGE observations observations VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
