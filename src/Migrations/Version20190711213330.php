 ...
 */
final class Version20190711213330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE image image VARCHAR(100) NOT NULL, CHANGE card_id card_id VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE card_id card_id VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE image image TINYTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
