 ...
 */
final class Version20190316134726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state INT NOT NULL, CHANGE days_of_consulting days_of_consulting INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE medic CHANGE state state SMALLINT DEFAULT NULL, CHANGE days_of_consulting days_of_consulting VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
